...
Source0  : https://archive.mgm51.com/mirrors/postfix-source/official/postfix-3.9.1.tar.gz
...
%prep
%setup -q -n postfix-3.9.1
cd %{_builddir}/postfix-3.9.1
pushd ..
cp -a postfix-3.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733397274
