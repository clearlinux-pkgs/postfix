...
Version  : 3.8.3
Release  : 36
URL      : https://archive.mgm51.com/mirrors/postfix-source/official/postfix-3.8.3.tar.gz
Source0  : https://archive.mgm51.com/mirrors/postfix-source/official/postfix-3.8.3.tar.gz
...
%prep
%setup -q -n postfix-3.8.3
cd %{_builddir}/postfix-3.8.3
pushd ..
cp -a postfix-3.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698935748
