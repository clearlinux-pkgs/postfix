...
Version  : 3.8.4
Release  : 37
URL      : https://archive.mgm51.com/mirrors/postfix-source/official/postfix-3.8.4.tar.gz
Source0  : https://archive.mgm51.com/mirrors/postfix-source/official/postfix-3.8.4.tar.gz
...
%prep
%setup -q -n postfix-3.8.4
cd %{_builddir}/postfix-3.8.4
pushd ..
cp -a postfix-3.8.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703272859
