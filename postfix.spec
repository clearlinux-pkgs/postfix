...
Source0  : https://archive.mgm51.com/mirrors/postfix-source/official/postfix-3.7.1.tar.gz
...
%prep
%setup -q -n postfix-3.7.1
cd %{_builddir}/postfix-3.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650326170
...
cp %{_builddir}/postfix-3.7.1/COPYRIGHT %{buildroot}/usr/share/package-licenses/postfix/51ed8894ca9a43ac82b3e637508197c3a1f6de30
cp %{_builddir}/postfix-3.7.1/LICENSE %{buildroot}/usr/share/package-licenses/postfix/0f78113e577104ec27d59b2b02c0d595c62ae6b4
cp %{_builddir}/postfix-3.7.1/conf/LICENSE %{buildroot}/usr/share/package-licenses/postfix/0f78113e577104ec27d59b2b02c0d595c62ae6b4
