...
%prep
%setup -q -n postfix-3.7.2
cd %{_builddir}/postfix-3.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651149855
...
cp %{_builddir}/postfix-3.7.2/COPYRIGHT %{buildroot}/usr/share/package-licenses/postfix/51ed8894ca9a43ac82b3e637508197c3a1f6de30
cp %{_builddir}/postfix-3.7.2/LICENSE %{buildroot}/usr/share/package-licenses/postfix/0f78113e577104ec27d59b2b02c0d595c62ae6b4
cp %{_builddir}/postfix-3.7.2/conf/LICENSE %{buildroot}/usr/share/package-licenses/postfix/0f78113e577104ec27d59b2b02c0d595c62ae6b4
