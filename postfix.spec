...
Source0  : https://archive.mgm51.com/mirrors/postfix-source/official/postfix-3.10.0.tar.gz
...
%prep
%setup -q -n postfix-3.10.0
cd %{_builddir}/postfix-3.10.0
pushd ..
cp -a postfix-3.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739893103
