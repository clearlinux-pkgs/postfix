...
Version  : 3.7.4
Release  : 32
URL      : https://archive.mgm51.com/mirrors/postfix-source/official/postfix-3.7.4.tar.gz
Source0  : https://archive.mgm51.com/mirrors/postfix-source/official/postfix-3.7.4.tar.gz
...
%prep
%setup -q -n postfix-3.7.4
cd %{_builddir}/postfix-3.7.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674667557
